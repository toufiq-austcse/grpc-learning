...
goog.exportSymbol('proto.sum.Numbers', null, global);
 ...
 * @constructor
 */
proto.sum.Numbers = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.sum.Numbers, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sum.Numbers.displayName = 'proto.sum.Numbers';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.sum.Numbers.prototype.toObject = function(opt_includeInstance) {
  return proto.sum.Numbers.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.sum.Numbers} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sum.Numbers.toObject = function(includeInstance, msg) {
  var f, obj = {
    num1: jspb.Message.getFieldWithDefault(msg, 1, ""),
    num2: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * @return {!proto.sum.Numbers}
 */
proto.sum.Numbers.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sum.Numbers;
  return proto.sum.Numbers.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.sum.Numbers} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sum.Numbers}
 */
proto.sum.Numbers.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.sum.Numbers.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sum.Numbers.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.sum.Numbers} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sum.Numbers.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getNum1();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * optional string num1 = 1;
 * @return {string}
 */
proto.sum.Numbers.prototype.getNum1 = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.sum.Numbers.prototype.setNum1 = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string num2 = 2;
 * @return {string}
 */
proto.sum.Numbers.prototype.getNum2 = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.sum.Numbers.prototype.setNum2 = function(value) {
...
proto.sum.SumRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    numbers: (f = msg.getNumbers()) && proto.sum.Numbers.toObject(includeInstance, f)
  };
...
proto.sum.SumRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.sum.Numbers;
      reader.readMessage(value,proto.sum.Numbers.deserializeBinaryFromReader);
...
proto.sum.SumRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.sum.Numbers.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.sum.Numbers}
 */
proto.sum.SumRequest.prototype.getNumbers = function() {
  return /** @type{?proto.sum.Numbers} */ (
    jspb.Message.getWrapperField(this, proto.sum.Numbers, 1));
};


/** @param {?proto.sum.Numbers|undefined} value */
proto.sum.SumRequest.prototype.setNumbers = function(value) {
 ...
 */
proto.sum.SumRequest.prototype.clearNumbers = function() {
 ...
 * @return {boolean}
 */
proto.sum.SumRequest.prototype.hasNumbers = function() {
